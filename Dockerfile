...
# ARG APP_SERVICE_HOSTNAME \
    ...
    # APP_DOCS_USERNAME\
    # APP_DOCS_PASSWORD \
    # APP_ADMIN_AUTH_USERNAME \
    # APP_ADMIN_AUTH_PASSWORD \
    # APP_ADMIN_AUTH_TOKEN \
    # APP_ADMIN_AUTH_SECRET_KEY \
...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    # APP_ADMIN_AUTH_USERNAME=${APP_ADMIN_AUTH_USERNAME} \
    # APP_ADMIN_AUTH_PASSWORD=${APP_ADMIN_AUTH_PASSWORD} \
    # APP_ADMIN_AUTH_TOKEN=${APP_ADMIN_AUTH_TOKEN} \
    # APP_ADMIN_AUTH_SECRET_KEY=${APP_ADMIN_AUTH_SECRET_KEY} \
